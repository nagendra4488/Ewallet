...
public class UserController {
	...
	/*
	 * @PostMapping("/public/authenticate") public UserCredentials
	 * getUser(@RequestBody UserCredentials credentials) throws
	 * UserNotFoundException { WalletUser user =
	 * userService.getUser(credentials.getUserId(), credentials.getPassword());
	 * 
