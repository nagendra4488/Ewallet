...
public class UserServiceImpl implements UserService{
	...
	/*
	 * @Override public WalletUser getUser(int userId, String password) throws
	 * UserNotFoundException{ // TODO Auto-generated method stub
	 * if(!userRepo.existsById(userId)){
	 * 
	 * throw new UserNotFoundException("Invalid UserID"); } return
	 * userRepo.findByUserIdAndPassword(userId, password); }
	 */
	@Override
